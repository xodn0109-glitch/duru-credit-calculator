...
const SUBJECT_ALIASES = [
  ...
  { aliases:["영어Ⅰ","영어1"],                                     targetIds:["EN_G1"] },
  { aliases:["영어Ⅱ","영어2"],                                     targetIds:["EN_G2"] },
  ...
  { aliases:["한국지리탐구","한국지리 탐구"],                               targetIds:["SO_G1"] },
  { aliases:["사회","사회와문화","사회와 문화","사회·문화","사회문화"],        targetIds:["SO_G2"] },
  { aliases:["세계사"],                                                       targetIds:["SO_G3"] },
  { aliases:["윤리와사상","윤리와 사상"],                                     targetIds:["SO_G4"] },
  { aliases:["법과사회","법과 사회"],                                       targetIds:["SO_G5"] },
  { aliases:["동아시아역사기행","동아시아 역사 기행"],                      targetIds:["SO_G6"] },
  { aliases:["현대사회와윤리","현대사회와 윤리"],                           targetIds:["SO_G7"] },
  { aliases:["세계시민과지리","세계시민과 지리"],                           targetIds:["SO_G8"] },
  ...
  { aliases:["물리학","물리"],                                        targetIds:["SC_G1"] },
  { aliases:["화학"],                                                 targetIds:["SC_G2"] },
  { aliases:["생명과학"],                                             targetIds:["SC_G3"] },
  { aliases:["지구과학"],                                             targetIds:["SC_G4"] },
